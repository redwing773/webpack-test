...
module.exports = {
    ...
    plugins : [
        ...
        new SpritesmithPlugin({
            ...
            apiOptions: {
              cssImageRef: '../../dist/sprite1.png',//참조될 위치와 파일명(ex>https://img.etoos.com/enp/front/main/web/images/sprites/sprite_common.png)
            },
        }),
        new SpritesmithPlugin({ //다른 스프라이트 이미지 생성
          ...
          apiOptions: {
            cssImageRef: 'https://img.etoos.com/enp/front/main/web/images/sprites/sprite_common.png', //참조될 위치와 파일명(ex>https://img.etoos.com/enp/front/main/web/images/sprites/sprite_common.png)
          },
      }),
